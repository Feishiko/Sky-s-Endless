if(room = rmDeath) {
	...
	if(showTimer >= 180) {
		draw_text(room_width/2, 120, "You killed " + string(round(lerp(monsterKilledNow[0], monsterKilled[0], .5))));
		draw_sprite_ext(sMonster, -1, room_width/2 + string_length("You killed " + string(monsterKilled[0])) + 70, 120, 4, 4, 0, c_white, 1);
	}
	if(showTimer >= 240) {
		draw_text(room_width/2, 160, "You killed " + string(round(lerp(monsterKilledNow[1], monsterKilled[1], .5))));
		draw_sprite_ext(sMonster2, -1, room_width/2 + string_length("You killed " + string(monsterKilled[1]))/2 + 70, 160, 4, 4, 0, c_white, 1);
	}
	if(showTimer >= 300) {
		draw_text(room_width/2, 200, "You killed " + string(round(lerp(monsterKilledNow[2], monsterKilled[2], .5))));
