...
if(global.language == 0){
	...
	draw_rectangle_color(room_width - 136, 115, room_width - 20, room_height - 32, c_black, c_black, c_black, c_black, false);

	draw_set_color(c_white);

	draw_text(room_width - 20, 115, JsonGetValue("help"))	
}
